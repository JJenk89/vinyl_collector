const Footer = () => {
    return (
        <footer className="max-w-screen-lg mx-auto bg-neutral-950 text-gray-400 py-8 px-4 pt-8 mt-8 border-t border-purple-950  bottom-0">
            ...
            <div className="max-w-7xl mx-auto font-mono text-xs text-center">
                ...
                <p className="">© 2025 - {new Date().getFullYear()} JJenk89 Web Dev</p> 
