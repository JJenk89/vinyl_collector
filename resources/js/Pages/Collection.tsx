    ...
    return (
        <div>
            ...
            <div className="container mx-auto min-w-full p-6 bg-neutral-950 text-gray-300 min-h-screen pt-20">
                ...
                {!auth.user ? (
                    <p className='font-mono min-h-screen'>Please <Link href='/register' className='underline text-indigo-600'>create an account</Link> or <Link href='/login' className='underline text-indigo-600'>log in</Link> to create a record collection!
                    </p>
                ) : (
                    <>
